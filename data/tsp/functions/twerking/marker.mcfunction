...
execute if score @s tsp.twerk.nx matches 1 run scoreboard players operation @s tsp.twerk.x *= @s tsp.twerk.n 
execute if score @s tsp.twerk.nz matches 1 run scoreboard players operation @s tsp.twerk.z *= @s tsp.twerk.n 
...
execute store result entity @s Pos[0] double 1 run scoreboard players get @s tsp.twerk.x
execute store result entity @s Pos[1] double 1 run data get entity @s Pos[1]
execute store result entity @s Pos[2] double 1 run scoreboard players get @s tsp.twerk.z
